...
echo -e "\033[96m
  ...
  ░█▄▄▄█ ░█ ░█ ░█░█░█ ░█ ▄▄ ▀▀  ▄ ░█ ░█▄▄▀
    ░█    ▀▄▄▀ ░█  ▀█ ░█▄▄█    ░█▄▄█ ░█ ░█ "
echo "                                   "
echo -e "\033[96m一键脚本工具 v1.6 （支持Ubuntu，Debian，Centos系统）\033[0m"
echo "------------------------"
echo "1. 系统信息查询"
echo "2. 系统更新"
echo "3. 系统清理"
    ...
    while true; do
      ...
      case $sub_choice in
          1)
              ...
              echo "alias $kuaijiejian='curl -sS -O https://raw.githubusercontent.com/yungjr/AWB/main/kejilion.sh && chmod +x kejilion.sh && ./kejilion.sh'" >> ~/.bashrc
          ...
          12)
            ...
            clear
            wget https://github.com/yungjr/AWB/raw/main/ChangeSource/swap.sh && bash swap.sh
            ;;
